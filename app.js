...
const uri = "mongodb+srv://priyasingh:Priya@cluster0.kepu1bm.mongodb.net/reserve?retryWrites=true&w=majority";
...
async function insertDataToMongoDB() {
  try {
    ...
    const result = await db.collection("state_district").insertMany(dataToInsert);
console.log(`${result.insertedCount} documents inserted.`);

const result2 = await db.collection("trips").insertMany(dataToInsert2);
console.log(`${result2.insertedCount} documents inserted.`);
  

const result3 = await db.collection("bus_owner").insertMany(dataToInsert3);
